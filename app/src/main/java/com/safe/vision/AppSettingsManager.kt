...
class AppSettingsManager private constructor(context: Context) {
    ...
    companion object {
        ...
        private const val KEY_BODY_PART_VIEW_ENABLED = "body_part_view_enabled"
        ...
        private const val KEY_LAST_VIEWED_MEDIA_PATH = "last_viewed_media_path"
    ...
    fun isBodyPartViewEnabled(): Boolean {
        return sharedPreferences.getBoolean(KEY_BODY_PART_VIEW_ENABLED, true)
    }

    fun setBodyPartViewEnabled(enabled: Boolean) {
        sharedPreferences.edit()
            .putBoolean(KEY_BODY_PART_VIEW_ENABLED, enabled)
            .apply()
    }
    ...
    fun getLastViewedMediaPath(): String? {
        return sharedPreferences.getString(KEY_LAST_VIEWED_MEDIA_PATH, null)
    }

    fun saveLastViewedMediaPath(path: String) {
        sharedPreferences.edit().putString(KEY_LAST_VIEWED_MEDIA_PATH, path).apply()
    }
